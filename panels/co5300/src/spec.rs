...
pub trait DisplaySpec: DisplaySize {
...
pub struct Am196q410502lk196410x502;
impl DisplaySize for Am196q410502lk196410x502 {
    const WIDTH: u16 = 410;
    const HEIGHT: u16 = 502;
    const COL_OFFSET: u16 = 22;
    const ROW_OFFSET: u16 = 0;
}
impl DisplaySpec for Am196q410502lk196410x502 {
    const INIT_PAGE_PARAM: u8 = 0x00;
    const IGNORE_ID_CHECK: bool = true;
}

/// AM178Q368448LK_178_368x448
pub struct Am178q368448lk178368x448;
impl DisplaySize for Am178q368448lk178368x448 {
    const WIDTH: u16 = 368;
    const HEIGHT: u16 = 448;
    const COL_OFFSET: u16 = 16;
    const ROW_OFFSET: u16 = 0;
}
impl DisplaySpec for Am178q368448lk178368x448 {
    const INIT_PAGE_PARAM: u8 = 0x00;
    const IGNORE_ID_CHECK: bool = true;
}

/// AM151Q466466LK_151_466x466_C
pub struct Am151q466466lk151466x466c;
impl DisplaySize for Am151q466466lk151466x466c {
    const WIDTH: u16 = 466;
    const HEIGHT: u16 = 466;
    const COL_OFFSET: u16 = 6;
    const ROW_OFFSET: u16 = 0;
}
impl DisplaySpec for Am151q466466lk151466x466c {
    const INIT_PAGE_PARAM: u8 = 0x00;
    const IGNORE_ID_CHECK: bool = true;
}

/// AM200Q460460LK_200_460x460
pub struct Am200q460460lk200460x460;
impl DisplaySize for Am200q460460lk200460x460 {
    const WIDTH: u16 = 460;
    const HEIGHT: u16 = 460;
    const COL_OFFSET: u16 = 10;
    const ROW_OFFSET: u16 = 0;
}
impl DisplaySpec for Am200q460460lk200460x460 {
    const INIT_PAGE_PARAM: u8 = 0x00;
    const IGNORE_ID_CHECK: bool = true;
}

/// H0198S005AMT005_V0_195_410x502
pub struct H0198s005amt005V0195410x502;
impl DisplaySize for H0198s005amt005V0195410x502 {
    const WIDTH: u16 = 410;
    const HEIGHT: u16 = 502;
    const COL_OFFSET: u16 = 44;
    const ROW_OFFSET: u16 = 0;
}
impl DisplaySpec for H0198s005amt005V0195410x502 {
    const INIT_PAGE_PARAM: u8 = 0x00;
    const IGNORE_ID_CHECK: bool = true;
}

// Amoled, 1.85Inch 390x450
pub struct Amoled185Inch390x450;
impl DisplaySize for Amoled185Inch390x450 {
    const WIDTH: u16 = 390;
    const HEIGHT: u16 = 450;
    const COL_OFFSET: u16 = 0;
    const ROW_OFFSET: u16 = 0;
}
impl DisplaySpec for Amoled185Inch390x450 {
...
impl DisplaySpec for GenericCo5300 {
    const INIT_PAGE_PARAM: u8 = 0x20; 
